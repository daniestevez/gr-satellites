...
# Description: TW-1C decoder
# Generated: Mon Jan 23 17:39:31 2017
##################################################
...
class tw_1c(gr.top_block):
    ...
    def __init__(self, callsign='', invert=1, ip='::', latitude=0, longitude=0, port=7355, recstart=''):
        ...
        self.sids_submit_0 = sids.submit('http://tlm.pe0sat.nl/tlmdb/frame_db.php', 40926, callsign, longitude, latitude, recstart)
...
def main(top_block_cls=tw_1c, options=None):
    if options is None:
