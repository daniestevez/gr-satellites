...
# Generated: Mon Jan 23 17:38:52 2017
##################################################
...
class gomx_3(gr.top_block):
    ...
    def __init__(self, callsign='', invert=1, ip='::', latitude=0, longitude=0, port=7355, recstart=''):
        ...
        self.msg_connect((self.csp_check_crc_0, 'ok'), (self.sids_print_timestamp_0, 'in'))    
        self.msg_connect((self.sids_print_timestamp_0, 'out'), (self.ax100_beacon_parser_0, 'in'))    
        ...
        self.msg_connect((self.sync_to_pdu_packed_0_0, 'out'), (self.ax100_gomx3_rs_decode_0, 'in'))    
        ...
        self.connect((self.digital_descrambler_bb_0_0, 0), (self.sync_to_pdu_packed_0_0, 0))    
