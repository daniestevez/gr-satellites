...
# Title: DUCHIFAT-2 decoder
# Author: Daniel Estevez
# Description: Decodes 9k6 AX.25 BPSK telemetry from DUCHIFAT-2
# Generated: Sun Apr 23 18:51:55 2017
##################################################
...
def main(top_block_cls=duchifat_2, options=None):
    if options is None:
